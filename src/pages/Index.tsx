  ...
  const projects = [
    {
      ...
      description:
        "A modern, responsive e-commerce platform built with React and TypeScript. Features include product catalog, shopping cart, user authentication, and payment integration.",
      technologies: [
        "React",
        "TypeScript",
        "TailwindCSS",
    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="py-8 px-4 border-t">
        <div className="max-w-6xl mx-auto text-center text-muted-foreground">
          <p>
            &copy; 2024 Alex Johnson. Built with React, TypeScript, and
            TailwindCSS.
          </p>
        </div>
      </footer>
