    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  ...
                  open-source projects, personal projects, or
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  link.href = '/Osinachi Chinedu C.V.pdf';
                  link.download = 'Osinachi Chinedu C.V.pdf';
      ...
      <footer className="py-8 px-4 border-t">
        <div className="max-w-6xl mx-auto text-center text-muted-foreground">
          <p>
            &copy; 2024 Osinachi Chinedu. Built with React, TypeScript, ShadCN UI, and
            TailwindCSS.
          </p>
        </div>
      </footer>
